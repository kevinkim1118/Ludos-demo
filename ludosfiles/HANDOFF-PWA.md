...
| `npm run smoke` | 41-check end-to-end walkthrough (needs dev running; `BASE_URL` retargets) |
...
- All **41 smoke checks pass**, zero console errors (29 original, five covering
  1a persistence, three the 1c install hint, four the viewport-fit fixes)
