...
| `npm run smoke` | 44-check end-to-end walkthrough (needs dev running; `BASE_URL` retargets) |
...
- All **44 smoke checks pass**, zero console errors (29 original, five covering
