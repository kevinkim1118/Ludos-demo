...
| `npm run smoke` | 37-check end-to-end walkthrough (needs dev running; `BASE_URL` retargets) |
...
- All **37 smoke checks pass**, zero console errors (29 original, five covering
  1a persistence, three covering the 1c install hint)
